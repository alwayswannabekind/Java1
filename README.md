// При игре больше, чем 3 на 3:
        ...
        // Соответсвенно победа в этой ситуации тоже не считается
// Так же я ещё не успел реализовать грамотную проверку победы по диаганалям( она работает только по главным диагоналям), т.е. при игре больше, чем 3 на 3, всё плохо
